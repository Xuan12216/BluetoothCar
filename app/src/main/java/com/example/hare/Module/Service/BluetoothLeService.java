package com.example.hare.Module.Service;
...
public class BluetoothLeService extends Service {
    ...
    private final UUID BLE_UUID_SERVICE = UUID.fromString("6E400001-B5A3-F393-E0A9-E50E24DCCA9E");
    private final UUID BLE_UUID_WRITE = UUID.fromString("6E400002-B5A3-F393-E0A9-E50E24DCCA9E");
    ...
    public boolean send(byte[] data) {
        BluetoothGattService mBluetoothGattService = mBluetoothGatt.getService(BLE_UUID_SERVICE);
        ...
        BluetoothGattCharacteristic characteristic =
                mBluetoothGattService.getCharacteristic(BLE_UUID_WRITE);
